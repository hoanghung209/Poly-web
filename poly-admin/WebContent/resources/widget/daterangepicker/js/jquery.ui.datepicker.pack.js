...
document.write( '<link rel="stylesheet" href="' + DATERANGEPICKER_ROOT + '/css/jquery.ui.datepicker.css"  type="text/css" />');

document.write( '<script type="text/javascript" src="' + DATERANGEPICKER_ROOT + '/js/jquery-ui-1.7.1.custom.min.js"></script>');
document.write( '<script type="text/javascript" src="' + DATERANGEPICKER_ROOT + '/js/jquery.ui.datepicker.js"></script>');