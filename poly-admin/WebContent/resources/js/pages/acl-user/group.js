...
function OnAssign() {
    ...
    if ($StringIsNullOrEmpty(listuser)) {
    	jAlert(LANG.MESSAGE.MUST_BE_CHECKED.f('{' + LANG.CONSTANT.groupNotAssigned + '}'), LANG.CONSTANT.alertDialog);
    	return false;
    }
    return true;
};
function OnUnAssign() {
     ...
     if ($StringIsNullOrEmpty(listuser)) {
    	 jAlert(LANG.MESSAGE.MUST_BE_CHECKED.f('{' + LANG.CONSTANT.groupAssigned + '}'), LANG.CONSTANT.alertDialog);
    	return false;
     }
     return true;
 };