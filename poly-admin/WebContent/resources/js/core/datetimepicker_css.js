...
var WeekDayName1=["Sun","Mon","Tue","Wed","Thir","Fri","Sat"];
var WeekDayName2=["Mon","Tue","Wed","Thir","Fri","Sat","Sun"];
...
function pickIt(evt) {
   ...
   if (window.addEventListener) { // w3c
      ...
      xpos = event.clientX + (de.scrollLeft || b.scrollLeft) - (de.clientLeft || 0) + XPOS;
      ypos = event.clientY + (de.scrollTop || b.scrollTop) - (de.clientTop || 0) + YPOS;
    }
