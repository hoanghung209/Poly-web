...
<c:url var="lastUrl" value="${query }/${totalPages}" >
</c:url>
<c:url var="prevUrl" value="${query }/${currIndex < 2 ? 1: currIndex - 1}" >
</c:url>
<c:url var="nextUrl" value="${query }/${currIndex >= totalPages ? totalPages: currIndex + 1}" >
</c:url>
    <ul class="pagination ">
        ...
        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
            <c:url var="pageUrl" value="${query }/${i}" />
            <c:choose>
