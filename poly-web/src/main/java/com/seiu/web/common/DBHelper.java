...
public class DBHelper {
	 public static Logger logger = Logger.getLogger(DBHelper.class);
	  ...
	  public static Map<String, String> getMapWithLimit(String sql, int start, int pageSize, Object... params)
	  {
	  ...
	  public static List<Map<String, String>> executeQueryWithLimit(String sql, int startIndex, int maxPageSize, Object... params)
	  {
	    List<Map<String, String>> result = null;
	    PreparedStatement stmt = null;
	    ResultSet rs = null;
