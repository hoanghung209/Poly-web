...
public class HttpUtils {
	 public static String getFullURL(HttpServletRequest request)
	  ...
	  public static void setCookie(String key, String value, int expiredTime, HttpServletResponse response, HttpServletRequest request)
	  {
	    ...
	    throws UnsupportedEncodingException
	  {
	    ...
	    for (String param : params.keySet())
	    {
	      ...
	      builder.append(param + "=" + URLEncoder.encode((String)params.get(param), "utf8"));
	    }
